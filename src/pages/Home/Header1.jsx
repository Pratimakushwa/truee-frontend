...
const NAV_CATEGORIES = [
  ...
  },
  {
    ...
    sub: [
      ...
      { label: "Bone Conduction Headphones", keyword: "Bone Conduction Headphones" },
    ],
  },
  {
    label: "EARPHONES",
    ...
    sub: [
      ...
      { label: "In-Ear Monitors (IEM)", keyword: "In-Ear Monitors (IEM)" },
      { label: "Truly Wireless Earbuds", keyword: "TWS" },
    ],
  },
  {
    label: "SMARTWATCHES",
...
export default function Header1() {
  ...
  const handleDropdownClick = () => {
    ...
    setTimeout(() => setCloseDropdown(false), 200); 
  };
      ...
      >
        ...
        {isSearchOpen ? (
          ...
          <nav className="hidden xl:flex items-center h-full gap-3 2xl:gap-6 relative z-50">
            {NAV_CATEGORIES.map((cat) => {
              ...
              return (
                ...
                >
                  ...
                  {cat.sub.length > 0 && (
                    <div className={`absolute top-[65%] left-1/2 -translate-x-1/2 pt-6 w-56 z-[10] transition-all duration-500 ease-out ${closeDropdown ? "hidden" : "opacity-0 invisible -translate-y-2 group-hover:opacity-100 group-hover:visible group-hover:translate-y-0"}`}>
            ...
            <div className="h-full flex items-center relative group">
              ...
              <div className={`absolute top-[65%] left-1/2 -translate-x-1/2 pt-6 w-64 z-[10] transition-all duration-500 ease-out ${closeDropdown ? "hidden" : "opacity-0 invisible -translate-y-2 group-hover:opacity-100 group-hover:visible group-hover:translate-y-0"}`}>
                <div className="bg-white border border-gray-100 rounded-2xl shadow-xl overflow-hidden py-2">
                  <div className="px-4 py-2 border-b border-gray-50 flex justify-between items-center">
                    <span className="text-[9px] font-black text-gray-400 uppercase tracking-widest">
                      Select Brand
        ...
        <div className="flex-1 xl:flex-none flex items-center justify-end gap-4 md:gap-5 h-full relative z-50">
          ...
          <div className="h-full flex items-center relative group">
            ...
            {user && (
              <div className={`absolute top-[65%] right-0 pt-6 w-56 z-[100] transition-all duration-500 ease-out ${closeDropdown ? "hidden" : "opacity-0 invisible -translate-y-2 group-hover:opacity-100 group-hover:visible group-hover:translate-y-0"}`}>
